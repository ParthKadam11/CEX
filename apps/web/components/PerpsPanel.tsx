  ...
  return (
    <div className="flex w-full flex-col lg:h-full lg:min-h-0">
      ...
      <TradeDeskLayout
            ...
            <form className="flex flex-1 flex-col gap-3" onSubmit={placeOrder}>
              <div className="rounded-md border border-zinc-100 px-3 py-2.5 dark:border-zinc-800">
                ...
                <div className="mt-1.5 flex justify-between gap-3 text-[11px] tabular-nums">
                  <span className="text-zinc-500">USD available</span>
                  <span className="text-zinc-950 dark:text-zinc-50">
                    {usd.available.toLocaleString()}
                  </span>
                </div>
                <div className="mt-1 flex justify-between gap-3 text-[11px] tabular-nums">
                  <span className="text-zinc-500">USD locked</span>
                  <span className="text-zinc-950 dark:text-zinc-50">
                    {usd.locked.toLocaleString()}
                  </span>
                </div>
              </div>
        ...
        bottom={
          <section className="flex h-full min-h-0 flex-col px-3 pt-2">
            <div className="mb-3 flex shrink-0 flex-wrap items-end justify-between gap-3 border-b border-zinc-200 dark:border-zinc-800">
              <div className="flex gap-6" role="tablist" aria-label="Perps desk">
                <button
                  type="button"
                  role="tab"
                  aria-selected={bottomTab === "position"}
                ...
                <button
                  type="button"
                  role="tab"
                  aria-selected={bottomTab === "orders"}
              ...
              {bottomTab === "position" ? (
                <span className="mb-2.5 text-xs text-zinc-400">

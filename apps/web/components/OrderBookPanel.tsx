...
const LEVELS_BOTH = 10;
const LEVELS_SINGLE = 18;
...
export function OrderBookPanel({
  ...
  return (
    <section className="flex h-[520px] max-h-[520px] flex-col overflow-hidden rounded-lg border border-zinc-200 bg-white text-zinc-950 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-100">
      ...
      {tab === "book" ? (
        <div className="flex min-h-0 flex-1 flex-col">
          ...
          <div className="flex min-h-0 flex-1 flex-col font-mono text-[12px] tabular-nums">
            {(view === "both" || view === "asks") && (
...
function TradesTab({ trades }: { trades: LiveTapeTrade[] }) {
  return (
    <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain font-mono text-[12px] tabular-nums">
        {trades.length === 0 ? (

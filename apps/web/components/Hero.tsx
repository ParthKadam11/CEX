...
const DEMO_CANDLES = [
  { o: 142, h: 146, l: 141, c: 145, up: true },
  { o: 145, h: 147, l: 143, c: 144, up: false },
  { o: 144, h: 148, l: 143, c: 147, up: true },
  { o: 147, h: 149, l: 145, c: 146, up: false },
  { o: 146, h: 150, l: 145, c: 149, up: true },
  { o: 149, h: 151, l: 147, c: 148, up: false },
  { o: 148, h: 150, l: 146, c: 147, up: false },
  { o: 147, h: 149, l: 146, c: 149, up: true },
  { o: 149, h: 152, l: 148, c: 151, up: true },
  { o: 151, h: 153, l: 149, c: 150, up: false },
  { o: 150, h: 152, l: 148, c: 149, up: false },
  { o: 149, h: 151, l: 147, c: 148, up: false },
  { o: 148, h: 150, l: 147, c: 150, up: true },
  { o: 150, h: 152, l: 149, c: 151, up: true },
  { o: 151, h: 153, l: 150, c: 152, up: true },
  { o: 152, h: 154, l: 150, c: 151, up: false },
  { o: 151, h: 153, l: 149, c: 150, up: false },
  { o: 150, h: 152, l: 149, c: 152, up: true },
  { o: 152, h: 155, l: 151, c: 154, up: true },
  { o: 154, h: 156, l: 152, c: 153, up: false },
  { o: 153, h: 155, l: 151, c: 154, up: true },
  { o: 154, h: 156, l: 153, c: 155, up: true },
  { o: 155, h: 157, l: 153, c: 154, up: false },
  { o: 154, h: 156, l: 152, c: 153, up: false },
  { o: 153, h: 155, l: 151, c: 152, up: false },
  { o: 152, h: 154, l: 150, c: 151, up: false },
  { o: 151, h: 153, l: 149, c: 152, up: true },
  { o: 152, h: 154, l: 151, c: 153, up: true },
  { o: 153, h: 155, l: 152, c: 154, up: true },
  { o: 154, h: 156, l: 153, c: 155, up: true },
] as const;
...
function LandingProductDemo() {
  ...
  const y = (price: number) =>
    ((priceMax - price) / (priceMax - priceMin)) * chartH;

  return (
    <div
      aria-label="CEX trading desk preview for SOL USD spot"
      className="bg-zinc-950 text-zinc-100"
    >
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2 border-b border-zinc-800 px-3 py-2.5 sm:px-4">
        ...
        <dl className="ml-auto hidden items-center gap-4 font-mono text-[10px] tabular-nums text-zinc-500 sm:flex">
          <div className="flex gap-1.5">
            <dt>Bid</dt>
            <dd className="text-emerald-300">148.32</dd>
          </div>
          <div className="flex gap-1.5">
            <dt>Ask</dt>
            <dd className="text-rose-300">148.35</dd>
          </div>
          <div className="flex gap-1.5">
            <dt>USD</dt>
          ...
          <div className="flex gap-1.5">
            <dt>SOL</dt>
            <dd className="text-zinc-200">84.25</dd>
          </div>
      ...
      <div className="grid lg:grid-cols-[1.35fr_0.85fr_0.9fr]">
        <div className="border-b border-zinc-800 lg:border-r lg:border-b-0">
          <div className="flex items-center justify-between border-b border-zinc-800 px-3 py-2">
            <span className="font-mono text-[10px] tracking-[0.16em] text-zinc-500 uppercase">
              Chart
            </span>
            <span className="font-mono text-[10px] text-zinc-500">15s live</span>
          </div>
          <div className="relative px-2 py-3 sm:px-3">
            <svg
              ...
              role="img"
              aria-label="Candlestick chart of SOL USD"
            >
              {[0.25, 0.5, 0.75].map((t) => (
                <line
                  key={t}
              ...
              {DEMO_CANDLES.map((c, i) => {
                const x = 8 + i * (chartW - 16) / DEMO_CANDLES.length;
        ...
        <div className="border-b border-zinc-800 lg:border-r lg:border-b-0">
          <div className="flex items-center justify-between border-b border-zinc-800 px-3 py-2">
            ...
            <span className="font-mono text-[10px] text-zinc-500">SOL-USD</span>
          </div>
          <div className="grid grid-cols-3 px-3 py-1.5 font-mono text-[9px] tracking-wider text-zinc-500 uppercase">
            <span>Price</span>
          ...
          <div className="font-mono text-[11px] tabular-nums">
            ...
            <div className="flex items-baseline gap-2 bg-zinc-900/80 px-3 py-2">
              <span className="text-base font-semibold leading-none text-emerald-300">
                148.32
              </span>
              <span className="text-[10px] text-zinc-500">148.335</span>
            </div>
            {BOOK_BIDS.map((row) => (
              <DepthRow
                key={`demo-bid-${row.price}`}
                price={row.price}
                size={row.size}
                total={row.total}
                maxTotal={maxTotal}
        ...
        <div className="flex flex-col">
          <div className="grid grid-cols-2 border-b border-zinc-800">
            <div className="border-r border-zinc-800 bg-emerald-500/15 px-3 py-2 text-center font-mono text-[11px] font-semibold tracking-[0.12em] text-emerald-300 uppercase">
              Buy
            </div>
            <div className="px-3 py-2 text-center font-mono text-[11px] tracking-[0.12em] text-zinc-500 uppercase">
              Sell
            </div>
          </div>
          <div className="flex flex-1 flex-col gap-3 px-3 py-3">
            ...
            <div className="grid grid-cols-2 gap-2 rounded-sm border border-zinc-800 bg-zinc-900/70 px-2.5 py-2 font-mono text-[11px] tabular-nums">
              <div>
                <p className="text-[9px] text-zinc-500 uppercase">USD</p>
                <p className="mt-0.5 text-zinc-100">12,480.00</p>
              </div>
              <div>
                <p className="text-[9px] text-zinc-500 uppercase">SOL</p>
                <p className="mt-0.5 text-zinc-100">84.250</p>
              </div>
            </div>
            <label className="block">
              ...
              <div className="mt-1 border border-zinc-700 bg-zinc-900 px-2.5 py-2 font-mono text-sm tabular-nums text-zinc-100">
                148.30
              </div>
            </label>
            <label className="block">
            ...
            <p className="font-mono text-[10px] tabular-nums text-zinc-500">
              Order value · 148.30 USD
            </p>
            <div className="mt-auto rounded-sm bg-emerald-500 px-3 py-2.5 text-center font-mono text-xs font-semibold tracking-[0.08em] text-zinc-950 uppercase">
              Buy SOL
            </div>
          </div>
        </div>

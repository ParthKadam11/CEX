...
type WalletCardProps = {
  ...
  /** When false, hides the welcome header (e.g. dashboard owns that row). */
  showWelcome?: boolean;
};
        ...
        >
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-4xl font-semibold tracking-tight text-zinc-950 dark:text-zinc-50">
                {loading ? (
            ...
            <button
              ...
              onClick={copyAddress}
              disabled={!publicKey}
              className="inline-flex items-center gap-2 rounded-md border border-zinc-200 px-3 py-1.5 text-sm text-zinc-600 transition hover:bg-zinc-50 disabled:opacity-50 dark:border-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-900"
            >
            ...
            {assetTab === "Wallet" && (
              <>
                ...
                {!loading && !error && (balance ?? 0) === 0 && (
                  <div className="mt-4 border-t border-zinc-100 pt-6 text-center dark:border-zinc-800">
                    <p className="text-sm text-zinc-500 dark:text-zinc-400">
                    ...
                    <button
                      ...
                      disabled={!publicKey}
                      onClick={() => setDepositOpen(true)}
                      className="mt-3 inline-flex h-9 items-center gap-2 rounded-md bg-zinc-950 px-4 text-sm font-medium text-white hover:bg-zinc-800 disabled:opacity-40 dark:bg-zinc-50 dark:text-zinc-950 dark:hover:bg-zinc-200"
                    >
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <div className="flex size-8 items-center justify-center rounded-full bg-zinc-100 dark:bg-zinc-800">
                              <Icon className="size-3.5 text-zinc-600 dark:text-zinc-300" />
                            </div>
                            <div>
                          ...
                          <div className="text-right">
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="inline-flex items-center gap-1 text-xs text-zinc-400 hover:text-zinc-700 dark:text-zinc-500 dark:hover:text-zinc-300"
                            >
                              {item.shortSignature}
